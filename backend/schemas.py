...
class SongUpdate(BaseModel):
    ...
    autor: Optional[str] = None
    tom_original: Optional[str] = None
    capotraste: Optional[int] = None
    bpm: Optional[int] = None
    compasso: Optional[str] = None
    introducao: Optional[str] = None
    finalizacao: Optional[str] = None
    cifra: Optional[str] = None
    observacoes: Optional[str] = None
    tags: Optional[List[SongTagRead]] = None  # se enviado, SUBSTITUI todas as tags
